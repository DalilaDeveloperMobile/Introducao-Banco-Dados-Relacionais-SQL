...
### ✅ Introdução a Banco de Dados Relacionais (SQL). [**Slides**](https://academiapme-my.sharepoint.com/:p:/g/personal/renato_dio_me/EUloXsuhqtlFhCo4xMkHQx4BPb7fa9M7rdkLTaBTKEnDsw?e=8cNnwO)
...
```
### <img src="https://gifs.eco.br/wp-content/uploads/2021/06/gifs-de-coracao-7.gif" width="30px"> Comandos: EXPLAIN SELECT, CREATE INDEX.
```sql
